...
val GreyText = Color(0xFFCECECE)
val GradientStartColor = Color(0xFF5090ED)
val GradientEndColor = Color(0xC9A05ED4)
val GreenButtonColor = Color(0xFFB3D271)
val TextColor = Color(0xFF7386E4)
val ErrorColor = Color(0xFFDD6363)